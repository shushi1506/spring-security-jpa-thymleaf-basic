...
public class RestFB {
    ...
    public String getToken(final String code) throws ClientProtocolException, IOException {
        ...
        System.out.println("Token facebook:"+node.textValue());
    ...
    public UserDetails buildUser(User user) {
        ...
        UserDetails userDetail = new org.springframework.security.core.userdetails.User(user.getId() + user.getName(), "", enabled, accountNonExpired, credentialsNonExpired,
